...
export default function VideosPage() {
  ...
  function handlePlay(meta: VideoMeta) {
      ...
      {showUpload && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0,0,0,0.88)' }}>
          <div className="w-full max-w-lg p-6 border border-white/10 overflow-y-auto max-h-[90vh]" style={{ backgroundColor: '#080808' }}>
            ...
            {/* 안내 */}
            <div className="mb-5 p-3 text-xs leading-relaxed border border-white/10 text-white/50" style={{ backgroundColor: '#0e0e0e' }}>
              영상은 YouTube에 올린 뒤 링크를 등록합니다.
              아이들 얼굴이 나오는 영상은 YouTube 업로드 시 <span className="text-white/80 font-bold">공개 범위를 &lsquo;일부공개&rsquo;</span>로
              설정하면 링크를 아는 사람만 볼 수 있습니다.
            </div>
